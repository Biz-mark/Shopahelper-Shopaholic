...
class AddCategoryToProductsByCategory extends Command
{
    use LinkHelper;
     ...
     */
    protected $name = 'shopahelper:link.add-category-to-products-by-category';
    ...
    public function handle()
    {
        ...
        if (!empty($obCurrentCategory->product)){
            foreach ($obCurrentCategory->product as $obProduct) {
